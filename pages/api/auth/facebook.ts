...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const scope = ['pages_manage_posts', 'pages_show_list', 'read_insights', 'pages_read_engagement', 'pages_read_user_content', 'instagram_basic', 'instagram_content_publish', 'instagram_manage_insights'];  // adjust scopes as needed
